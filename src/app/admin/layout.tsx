...
import { Home, Users, ArrowDownToDot, ArrowUpFromDot, List, Settings, LogOut, MessageSquare, Bell, User, ShieldCheck } from 'lucide-react';
                ...
                {admin && (
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground hidden sm:block">{admin.email}</p>
                        </div>
                    </div>
                )}
            </div>
